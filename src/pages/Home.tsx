                  ...
                  <div className="p-1.5 bg-white/10 backdrop-blur-md border-t border-white/20">
                    ...
                    {vendor.contact_phone && (
                      <button
                        ...
                        className="w-full bg-green-500 text-white text-xs py-1 px-2 rounded-lg hover:bg-green-600 transition-all duration-200 flex items-center justify-center gap-1 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform"
